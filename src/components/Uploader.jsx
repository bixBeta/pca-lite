    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden
      ...
      <div className="relative w-full max-w-2xl animate-slide-up">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-center text-sm max-w-sm leading-relaxed" style={{ color: 'var(--text-2)' }}>
            Upload a PCA CSV or a{' '}
            <code className="text-xs px-1 py-0.5 rounded"
                  style={{ backgroundColor: 'var(--bg-card)', color: '#a78bfa' }}>prcomp</code>{' '}
            RDS from <span style={{ color: '#6366f1' }}>TREx</span> to explore interactive{' '}
